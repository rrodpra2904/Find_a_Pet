...
<head>
    ...
    <style>
        ...
        .contenedor-filtros input, .contenedor-filtros select {
            padding: 8px 12px;
            border: 2px solid #ccc; /* Un poquito más grueso para que se note el cambio */
            border-radius: 6px;
            ...
            min-width: 150px;
            outline: none;
            transition: all 0.2s ease; /* Transición suave para el color */
        }

        /* EFECTO DE COLOR MORADO AL SEÑALAR/SELECCIONAR EL FILTRO */
        .contenedor-filtros input:focus, .contenedor-filtros select:focus {
            border-color: #8a2be2 !important; /* Color morado vibrante */
            box-shadow: 0 0 8px rgba(138, 43, 226, 0.2) !important; /* Brillo morado suave alrededor */
        }
